...
create table Vote as select * from B3;	
...
\copy (select page,row,col from TableColumn where vote_type=0) To '/home/aha/Project/GovCash/res/rerun.csv' With CSV HEADER
\copy (select * from TableColumn) To '/home/aha/Project/GovCash/res/table_column.csv' With CSV HEADER
\copy (select * from Vote) To '/home/aha/Project/GovCash/res/vote.csv' With CSV HEADER
\copy (select * from UserInfo) To '/home/aha/Project/GovCash/res/user_info.csv' With CSV HEADER
